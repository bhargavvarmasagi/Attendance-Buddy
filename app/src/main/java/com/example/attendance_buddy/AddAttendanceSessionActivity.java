...
public class AddAttendanceSessionActivity<AddAttandanceActivity> extends Activity {
    ...
    String branch = "ACS";
    String year = "SEM 2";
    String subject = "Mobile Computing - Android";

    private String[] branchString = new String[] { "ACS", "IS"};
    private String[] yearString = new String[] {"SEM1","SEM2","SEM3"};
    private String[] subjectSEString = new String[] {"WebApps","Java"};
    private String[] subjectTEString = new String[] {"Android","iOS"};
    private String[] subjectBEString = new String[] {"PM","DV"};

    private String[] subjectFinal = new String[] {"Java","WebApps","Android","iOS","PM","DV"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(AddAttandanceSessionActivity.this, com.android.attendance.activity.AddAttendanceActivity.class);
